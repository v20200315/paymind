"""
Django settings for paymind project.
...
SECRET_KEY = "django-insecure-hvxt8n5c3&k1*uw-@i3#j#8lsc=)nhopd^f#ge&16uk00pg7#h"
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR / "webpages" / "static"]
...
SIMPLE_JWT = {
    ...
    "BLACKLIST_AFTER_ROTATION": True,  # 旧 Refresh Token 是否加入黑名单
}
